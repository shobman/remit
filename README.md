...
**Version 0.1.1. Early, and in use.**
...
```sh
curl -fsSL https://raw.githubusercontent.com/shobman/remit/main/get-remit.sh | REMIT_REF=v0.1.1 sh -s -- /path/to/your-repository
```

Place `REMIT_REF=v0.1.1` immediately before `sh`, the last command in the pipeline, so
