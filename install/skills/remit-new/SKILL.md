...
escalated — the item's `log.md` carries the reason and any proposal in it is for him to rule
on, never to apply. Then stop: no elaborating, ranking, estimating, or raising it later
unasked.
